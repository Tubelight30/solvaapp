...
import 'package:solveathon/face/authenticate_face/scanning_animation/animated_view.dart';
import 'package:solveathon/face/authenticate_face/user_details_view.dart';
...
import 'package:solveathon/face/common/utils/extract_face_feature.dart';
import 'package:solveathon/face/common/views/camera_view.dart';
...
class _AuthenticateFaceViewState extends State<AuthenticateFaceView> {
  ...
  int trialNumber = 1;
//12.844642094961655, 80.15278095850485
//12.839534878595845, 80.15505929325407
  Future<void> checkLocationAndMarkAttendance() async {
    const double targetLatitude = 12.839534878595845;
    const double targetLongitude = 80.15505929325407;
